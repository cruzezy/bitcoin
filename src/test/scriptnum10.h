...
#ifndef NETGOLD_TEST_SCRIPTNUM10_H
#define NETGOLD_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Netgold Core 0.10.0, for cross-comparison.
 */
public:
