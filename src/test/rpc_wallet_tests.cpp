...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CNetgoldAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CNetgoldAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CNetgoldAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CNetgoldAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CNetgoldAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CNetgoldAddress(arr[0].get_str()).Get() == demoAddress.Get());
