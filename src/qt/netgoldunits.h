...
#ifndef NETGOLD_QT_NETGOLDUNITS_H
#define NETGOLD_QT_NETGOLDUNITS_H
...
/** Netgold unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NetgoldUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NetgoldUnits(QObject *parent);

    /** Netgold units.
      @note Source: https://en.netgold.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NTG,
...
typedef NetgoldUnits::Unit NetgoldUnit;

#endif // NETGOLD_QT_NETGOLDUNITS_H
