...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/netgold"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Netgold Core"),
     ...
     * override -datadir in the netgold.conf file in the default data directory
     * (to be consistent with netgoldd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
