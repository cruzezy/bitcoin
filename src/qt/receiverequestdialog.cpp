...
#include "config/netgold-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatNetgoldURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + NetgoldUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatNetgoldURI(info));
}
