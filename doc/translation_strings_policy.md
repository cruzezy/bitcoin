...
This document provides guidelines for internationalization of the Netgold Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `netgold_en.ts` remains unchanged.
